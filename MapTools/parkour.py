...
class Parkour:
    ...
    def add_checkpoint(self, loc):
        self.checkpoints.append(loc)

    def remove_checkpoint(self, cp):
    ...
    def render(self, screen):
        ...
        self.render_checkpoints(screen)
    ...
    def render_checkpoints(self, screen):
        for cp in self.checkpoints:
            pygame.draw.circle(screen, (0, 0, 255), cp, 6)
